...
def generate_tumor_map(classifier_class, indexed_slices_list):
    ...
    final_mask_cube = flair_array  # np.add(np.add(np.add(flair_array, t1_array), t1c_array), t2_array)
    # endregion
